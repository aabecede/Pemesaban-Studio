...
include 'koneksi.php';
$user = $_SESSION['user'];
	$ceklvl = mysql_query("select * from user where user ='$user'")or die(mysql_error());
	$aceklvl = mysql_fetch_array($ceklvl);
		...
		<div id="site-content">
			<header class="site-header">
				<div class="container">
					...
					{
					?>
					<img src="../dummy/dw.jpg" alt="Site Title">
					<?php
					}else{
					?>
					<img src="dummy/dw.jpg" alt="Site Title">
					...
					?>
						...
						<small class="site-description">Life With Music</small>
					</a> <!-- #branding -->
					...
					<nav class="main-navigation">
						...
						if($aceklvl['level'] == 'user')
						{
							...
							<li class="menu-item"><a href="pesanstudio.php">Pesan Studio</a></li>
							<!--<li class="menu-item"><a href="blog.html">Blog</a></li>-->
						<!--	<li class="menu-item"><a href="kontak.php">Kontak</a></li> -->
							<li class="menu-item"><a href="javascript:void(0);" id="jwpopupLink"><span class="glyphcon glyphcon-user"></span><?php echo $user;?></a></li>
					...
					<div class="jwpopup-content">
						...
						<div class="jwpopup-main">
								...
								<table>
									<tr>
										<td>Nama</td>
										<td><?php echo $aceklvl['nama'];?></td>
									</tr>
									<tr>
										<td>Alamat</td>
										<td><?php echo $aceklvl['alamat'];?></td>
									</tr>
									<tr>
										<td>Telepon</td>
										<td><?php echo $aceklvl['telp'];?></td>
									</tr>
									<tr>
										<td>Username</td>
										<td><?php echo $aceklvl['user'];?></td>
									</tr>
									<tr>
										<td>Password</td>
										<td><input type="password" readonly="" value="<?php echo $aceklvl['pass'];?>"></td>
									</tr>
									<tr>
										<td>Sisa Deposit</td>
										<td><?php 
										if($aceklvl['deposit'] == null)
										{

											echo '0';
										}else{
											echo $aceklvl['deposit'];
										}
										?></td>
									</tr>
									<tr>
										<td colspan="2"><a href="../log.php?op=out" class="button">Logout</a></td>
									</tr>
