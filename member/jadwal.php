					...
					<div class="container">
						<div class="content fullwidth">
							...
							<div class="filterable-items">
								...
								$now = $atoday['now'];
								$seljadwal = mysql_query("select *, user.nama as namus from pesan, user, tbl_ruang where pesan.idpemesan = user.id and tbl_ruang.id = pesan.ruangan and pesan.tanggal > '$now' order by tanggal asc");
